...
//                 if (!movePiece(lastGamePiece, currentDiceRoll))
//                 {
//                     // If not possible to move wait and inform player
//                     printDebug("Not possible to move");
//                 }
//             }
//             else
//             {
//                 // Determine pieces to move
//                 std::vector<IGamePiece_SPTR> moveAblePieces = determineMoveablePieces(currentPlayer);
//                 std::vector<IGamePiece_SPTR> possible = determinePossiblePieces(moveAblePieces, currentDiceRoll);
//                 std::vector<IGamePieceUI_SPTR> possiblePieces = convertForUI(possible);
//                 // Ask player which piece to move
//                 IGamePieceUI_SPTR tempGamePiece = ui->chooseGamePiece(possiblePieces, currentPlayer);
//                 IGamePiece_SPTR pieceToMove = std::static_pointer_cast<IGamePiece>(tempGamePiece);
//                 if (!movePiece(pieceToMove, currentDiceRoll))
//                 {
//                     // If not possible to move wait and inform player
//                     printDebug("Not possible to move");
//                 }
...
// std::map<IGamePiece_SPTR, std::vector<std::pair<int, bool>>> MainLogic::getGamePiecesWithNewPositions(int diceRoll){
...
//         if(diceRoll == 6)
//         { // 6 Check
//             if(rules->allowedToUseOutsidePieceOnSixWhenPiecesLeftHome()){
...
//                 } else{
//                     if(board->getHomeAreaTeam(currentPlayer).size() == 0){
//                         std::pair<int, bool> position;
...
// std::vector<IGamePiece_SPTR> MainLogic::determinePossiblePieces(std::vector<IGamePiece_SPTR> &moveablePieces, int numberOfSteps)
// {
...
// }
// // int MainLogic::getJumpPosition(int field)
// // {
...
// // void MainLogic::addPlayerToWinnersIfNotPresent(int player)
// // {
...
//         if (oneTeamFinished)
//         {
//             if (rules->playUntilAllPlayersFinished())
//             {
//                 return true;
//             }
//             else
