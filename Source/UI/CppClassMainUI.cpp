...
std::pair<IGamePieceUI_SPTR, std::pair<int, bool>> UI::chooseOneGamePiece(std::map<IGamePieceUI_SPTR, std::vector<std::pair<int, bool>>> &possiblePieces, int currentPlayer) {
...
void UI::showInformation(std::string message) {
    std::cout << std::endl << color_red << message << color_reset << std::endl;
}
...
void UI::rollDice(std::string currentPlayer, int diceNumber) {    
    ...
    std::cout << std::endl << color_red << currentPlayer << color_green << ", du bist an der Reihe zu würfeln." << std::endl << "Drücke dazu ENTER." << color_reset << std::endl;
    ...
    std::cout << std::endl << color_red << diceMessage << color_green << std::endl << "Drücke ENTER um fortzufahren." << color_reset << std::endl;
