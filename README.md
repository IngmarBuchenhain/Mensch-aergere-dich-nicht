...
2. Run 'make' in 'Source'-directory. You can provide a path to which the executable ('maedn') should be build via 'make outpath=path/you/like' (tested on macos 12 (Arm/Intel)).
3. With 'make run' you can run a quick pre-configured game
4. If you want to you can use the alternative TestUI. Simply alter the commentation in lines 136/137 in CppMenschAergereDichNicht.cpp and build again.
### Run the game
